...
public class ESQueryConstructor {
     ...
     * 增加简单条件表达式 
     */
    public ESQueryConstructor must(ESCriterion criterion){
        if(criterion!=null){
     ...
     * 增加简单条件表达式
     */
    public ESQueryConstructor should(ESCriterion criterion){
        if(criterion!=null){
     ...
     * 增加简单条件表达式
     */
    public ESQueryConstructor mustNot(ESCriterion criterion){
        if(criterion!=null){
